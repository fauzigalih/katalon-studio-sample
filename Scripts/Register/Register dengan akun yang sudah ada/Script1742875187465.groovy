...
WebUI.sendKeys(findTestObject('Register/input_password'), GlobalVariable.password)
WebUI.delay(GlobalVariable.delay)

WebUI.click(findTestObject('Register/btn_register'))
WebUI.verifyElementText(findTestObject('Register/modal_register_email_sudah_terdaftar'), 'Sorry, Email sudah terdaftar')
